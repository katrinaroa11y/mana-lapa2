  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center pt-28 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#FAF8F2]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
         Klīniskās psiholoģes konsultācijas pieaugušajiem trauksmes, stresa, izdegšanas, attiecību grūtību, psiholoģisko traumu un citu emocionālu grūtību gadījumos. Konsultācijas attālināti visā Latvijā.
        </motion.p>
