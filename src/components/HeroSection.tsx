...
const DEFAULT_PORTRAIT = '/katrina_portrait.jpg';
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center pt-28 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#FAF8F2]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
         Klīniskās psiholoģes konsultācijas. Palīdzu pārvarēt trauksmi, stresu, izdegšanu un psiholoģiskās traumas sekas, lai veidotu mierīgāku un līdzsvarotāku dzīvi. Konsultācijas attālināti, kā arī psihologa vadīti semināri uzņēmumiem Rīgā un visā Latvijā.
        </motion.p>
