...
Manu profesionālo pieeju veido gan daudzveidīgā izglītība un darba pieredze, ko ieguvu Latvijā un Vācijā, gan miers un vienkāršība, ko piedzīvoju uzaugot lauku viensētā Kurzemē. Šis pieredžu kopums ļauj man saglabāt **augstus profesionālos standartus**, vienlaikus paliekot patiesi klātesošai un cilvēcīgai.

**Es ticu, ka ikvienā cilvēkā ir spēks un resurss pārvarēt grūtības**, taču nereti to ir grūti saskatīt vienatnē. Mans mērķis ir radīt **drošu un atbalstošu vidi**, kurā kopā varam palīdzēt Tev iepazīt sevi labāk, izprast notiekošo, atklāt vēl, iespējams, neatklātus resursus un rast ceļu uz pārmaiņām.
...
export const AboutSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 right-0 w-72 h-72 bg-[#A8C3A1]/10 rounded-full blur-3xl pointer-events-none" />
                ...
                <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl glass-panel shadow-sm border border-[#E8E1D8]/80">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#5E6A71] font-medium">
