...
**Es ticu, ka ikvienā cilvēkā ir spēks un resurss pārvarēt grūtības**, taču nereti to ir grūti saskatīt vienatnē. Mans mērķis ir radīt **drošu un atbalstošu vidi**, kurā palīdzēt Tev iepazīt sevi labāk, izprast notiekošo, apzināties jaunus resursus un rast ceļu uz pārmaiņām.
...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section
      id="par-mani"
      className="relative py-20 lg:py-28 px-4 sm:px-6 lg:px-8 bg-[#FAF8F2]"
    >
      {/* Soft background shape */}
      <div className="absolute top-20 right-0 w-96 h-96 bg-[#A8C3A1]/10 rounded-full blur-3xl pointer-events-none" />
