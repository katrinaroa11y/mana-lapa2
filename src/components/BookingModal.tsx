                ...
                >
                    ...
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={
                            'w-full p-3.5 rounded-xl border text-sm focus:outline-none focus:ring-2 ' +
                            (
                      ...
                      <div>
                        ...
                        <div className="space-y-2.5">
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            {TIME_SLOTS.slice(0, 2).map((slot) => (
                              <button
                                ...
                                className={
                                  'py-3 px-4 rounded-xl text-sm font-medium border transition-all flex items-center justify-center space-x-2 ' +
                                  (
                          ...
                          <button
                            ...
                            className={
                              'w-full py-3 px-4 rounded-xl text-xs sm:text-sm font-medium border transition-all flex items-center justify-center space-x-2 ' +
                              (
                  ...
                  {step === 4 && (
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start space-x-2 pt-2">
                        ...
                        >
                          Piekrītu manu datu apstrādei pieteikuma apstrādes
                          un saziņas nodrošināšanai (saskaņā ar VDAR).
                        </label>
                  ...
                  <div className="pt-6 border-t border-[#E8E1D8] flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={
                        'inline-flex items-center space-x-2 px-6 py-3 rounded-xl font-medium text-sm transition-all shadow-sm ' +
                        (
                          step === 3 &&
                          isWeekendSelected(formData.date)
