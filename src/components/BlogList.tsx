      ...
      <div className="max-w-7xl mx-auto">
        ...
        {isPage && (
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-base sm:text-lg text-[#3E4950] max-w-2xl mx-auto font-normal leading-relaxed">
            ...
            >
              ...
              <div className="p-6 sm:p-7 flex flex-col flex-grow justify-between space-y-4">
                ...
                <div className="space-y-2 flex-grow">
                  ...
                  <p className="text-sm text-[#3E4950] line-clamp-3 font-normal leading-relaxed pt-1">
                    {post.excerpt}
                  </p>
                </div>
