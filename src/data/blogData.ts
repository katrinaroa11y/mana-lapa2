    ...
    content: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: `1. Ievies mazas pauzes darba dienas laikā (jau 5 minūšu pastaiga vai 2 minūtes apzinātas elpošanas ik pēc stundas var radīt lielas pārmaiņas ilgtermiņā).\n2. Definē skaidru robežu starp darba laiku un privāto dzīvi. Pat <b>ja amats prasa būt sasniedzamam arī ārpus normēta darba laika</b>, ir svarīgi nospraust robežas, kas pasargā tavu mieru un veselību. Piemēram, deliģēt kādus pienākumus vai nodalīt darba tālruni no personīgā. Kā arī, noteikt konkrētus laika logus, kuros vakaros un brīvdienās neesi pieejams telefoniski. Var būt periodi, kad darbs ārpus darba laika ir neizbēgams un, piemēram, ir jāpabeidz liels projekts, jāstrādā vairāk kā ierasts. Bet arī tad smadzenēm ir nepieciešams laiks atpūtai. Piemēram, pēc ik stundas darba 30 minūtes izej pastaigā vai pavadi laiku ar ģimeni bez viedierīcēm. Alternatīva ir sadalīt dienu - x stundas darbam, x stundas laikam ar ģīmeni un sev. Atpūta ne tikai mazinās spriedzi, bet arī ļaus saglabāt fokusu un produktivitāti. \n3. Praktizē līdzjūtību pret sevi un atzīsti sev, ka cilvēkiem nav iespējams būt perfektiem. Reizēm arī ''pietiekami labi'' ir labākais iespējamais rezultāts. `
        }
      ],
      keyTakeaways: [
