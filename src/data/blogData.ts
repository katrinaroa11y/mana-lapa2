      ...
      sections: [
        {
          ...
          body: `<b>Izteikti negatīva vai traumatiska pārdzīvojuma laikā mūsu smadzenes var tikt pārslogotas, un dabiskais informācijas apstrādes process var apstāties.</b> Atbrīvot no smadzeņu procesu ''iestrēgšanas'' var EMDR metode, kuras pamatā ir abpusēja jeb bilaterālā stimulācija. Visbiežāk stimulācija notiek ar ritmiskām acu kustībām, skaņas signāliem vai viegliem pieskārieniem, kas pārmaiņus aktivizē labo un kreiso smadzeņu puslodi. Šis process atgādina to, kas dabiski notiek smadzenēs miega ātrajā (REM) fāzē, un palīdz smadzenēm drošā veidā "pārstrādāt" iestrēgušās atmiņas un emocijas.`
        },
        {
          heading: 'Kādos gadījumos EMDR ir piemērota metode?',
          body: `EMDR terapija ir piemērota cilvēkiem, kuri ir <b>piedzīvojuši dažāda veida traumatisku pieredzi </b> - gan vienu īpaši smagu notikumu, gan ilgstoši uzkrājušās negatīvas pieredzes. Traumatiskas pieredzes ir, piemēram, fiziska vai emocionāla vardarbības, bullings un mobings, nelaimes gadījumi, pieredzēti militāri konflikti, dabas katastrofas un tuva cilvēka pēkšņs zaudējums. EMDR terapija var būt arī noderīga cilvēkiem, kuri ilgstoši piedzīvojuši emocionālu nolaidību no vecāku puses bērnībā (vecāki nebija klāt, atstāja ilgstoši vienu tam nepiemērotā vecumā, nereaģēja uz bērna vajadzībām). Un tomēr, EMDR der ne tikai traumu sekām. Šīs metodes efektivitāte ir pētīta plašam spektram grūtību, un  <b>var būt palīdzoša arī fobijām, izdegšanai, zemam pašvērtējumam</b> un citiem psiholoģiskās veselības apgrūtinājumiem.
