    ...
    content: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: `1. Ievies mazas pauzes darba dienas laikā (jau 5 minūšu pastaiga vai 2 minūtes apzinātas elpošanas ik pēc stundas var radīt lielas pārmaiņas ilgtermiņā).\n2. Definē skaidru robežu starp darba laiku un privāto dzīvi. Pat ja tavs amats prasa būt sasniedzamam arī ārpus normēta darba laika, ir svarīgi nospraust robežas, kas pasargā tavu mieru un veselību. Piemēram, nodalīt darba tālruni no personīgā vai arī noteikt konkrētus laika logus, kuros vakaros un brīvdienās neesi pieejams telefoniski. Tas pats ar darbu pie datora pēc darba laika - var būt periodi, kad tas ir neizbēgams un liels projekts ir jāpabeidz un jāstrādā vairāk kā ierasts. Bet arī tad smadzenēm ir nepieciešams laiks atpūtai. Piemēram, pēc ik stundas darba 30 minūtes izej pastaigā bez viedierīcēm vai arī pavadi laiku ar tuviniekiem. Alternatīva ir sadalīt dienu - x stundas darbam, x stundas laikam ar ģīmeni un sev, un pie tā arī pieturēties. \n3. Praktizē līdzjūtību pret sevi un atzīsti sev, ka cilvēkiem nav iespējams būt perfektiem. Reizēm arī ''pietiekami labi'' ir labākais iespējamais rezultāts. `
        }
      ],
      keyTakeaways: [
